        ...
        return (
                <Grid container textAlign='center' verticalAlign='middle' style={{marginTop: '32px'}}>
                    <Grid.Row style={{maxWidth: 600}}>
                        <Grid.Column>
                            <Header attached='top' as='h2' textAlign= 'center' color='red' >
                                Welcome to the Game 
                                <Header.Subheader style={{color: 'black'}}>Please Log In First</Header.Subheader>
                            </Header>
                            <Form onSubmit={this.handleSubmit}>
                                <Segment>
                                <Dropdown placeholder='Select User' selection options={userInfo} onChange={this.handleSelection} />                                </Segment>
                                <Divider horizontal />
                                <Button color='red' disabled ={ authedUserId === ''}>       
                                    Log In
                                </Button>
                            </Form>
                        </Grid.Column>
