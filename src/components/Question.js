            ...
            <div>
                <Container style={{marginTop: '32px', width: 540}} >
                    <Grid inverted stackable columns='equal' >
                        <Grid.Row >
                            <Grid.Column >
                                <Header color='red' attached = 'top' block as='h2'>{name} Asks: </Header>
                                <Segment attached>
                                    <Item.Group>
                                        <Item>
                                        <Item.Image size='small' src={avatarURL} alt={`${name}'s picture`} />
                                        <Item.Content verticalAlign='bottom'>
                                            <Item.Header>What Would You Rather ?</Item.Header>
                                            <Item.Description>...{question.optionOne.text} or ...</Item.Description>
                                            <Divider horizontal></Divider>
                                            <Item.Extra>
                                                <Button onClick={this.handleRedirectToPoll} color='red' fluid >View Poll</Button>
                                            </Item.Extra>
                                        </Item.Content>
                                        </Item>
                                    </Item.Group>
