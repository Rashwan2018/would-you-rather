...
class BoxResault extends Component {
    render() {
        ...
        return (
            <Container style={{marginTop: '32px', width: 800}}>
                <Grid stackable columns='equal' divided verticalAlign='middle' >
                    <Grid.Row>
                        <Grid.Column>
                            <Header color='green' as='h2' attached='top' block>{name} Asks:</Header>
                            <Segment attached>
                                <Item.Group relaxed>
                                    <Item>
                                        ...
                                        <Item.Content>
                                            ...
                                            <Item.Description>
                                                <Segment>
                                                    <Header>
                                                        {userVote === 'optionOne'
                                                            ? (<Label color='green' corner><Icon name='check' /></Label>) 
                                                            : ''
                                                        }
                                                    <Header.Content>Option one</Header.Content>
                                                    </Header>
                                                    <Progress percent ={firstQuestionPercentage} progress color='green'  />
                                                ...
                                                <Segment>
                                                    ...
                                                    <Progress percent ={secondQuestionPercentage} progress color='green'  />
...
export default  connect(mapStateToProps)(BoxResault)